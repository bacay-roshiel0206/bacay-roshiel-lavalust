...
<head>
    ...
    <style>
        :root {
            /* ── BAGONG COLOR PALETTE (Cyber Emerald & Deep Indigo) ── */
            --c-bg: #060B11;
            --c-card: #0D1520;
            --c-dark: #060B11;
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body { background: var(--c-dark); overflow-x: hidden; color: #E2E8F0; }
        ...
        .parallax-bg {
            ...
            filter: brightness(0.2) saturate(1.2) hue-rotate(120deg);
        }
        .parallax-overlay {
                ...
                <table class="glass-table">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <div style="display:flex; align-items:center; gap:8px;">
                                    <i data-lucide="mail" style="width:14px; height:14px; opacity:0.8;"></i>
                                    Email
                                </div>
                            </th>
                            <th>
                                <div style="display:flex; align-items:center; gap:8px;">
                                    <i data-lucide="at-sign" style="width:14px; height:14px; opacity:0.8;"></i>
                                    Username
                                </div>
                            </th>
                        </tr>
